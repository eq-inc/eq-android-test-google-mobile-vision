...
public class AllDetectFromCameraActivity extends AbstractDetectActivity implements OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (needFinish) {
            ...
            setContentView(R.layout.activity_all_detect_from_camera);
    ...
    private TextWatcher mDetectFpsChangedListener = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            try {
                ...
                ToastUtil.showToast(AllDetectFromCameraActivity.this, e.getLocalizedMessage(), Toast.LENGTH_LONG);
            }
        }
    };
}
